const setTitle = (title: string) => {
    return title ? `${title}` : 'ERP';
};

// const defaultRedirectRoute = [
//   {
//     path: '/',
//     redirect: '/unidades', // 👈 tu nueva ruta por defecto
//   },
// ]
const bienvenidaRoutes = [
  {
    path: '/',
    name: 'welcome',
    meta: {
      title: setTitle('Bienvenida'),
      authRequired: true
    },
...
const rutasRoutes = [
  {
    path: '/rutas',
    name: 'catalogos.rutas',
    meta: {
      title: setTitle('Rutas'),
      authRequired: true
    },
...
const operadoresRoutes = [
  {
    path: '/operadores',
    name: 'catalogos.operadores',
    meta: {
      title: setTitle('Operadores'),
      authRequired: true
    },
    component: () => import('@/views/catalogos/operadores/index.vue')
  }
]
const razones_socialesRoutes = [
  {
    path: '/razones_sociales',
    name: 'catalogos.razones_sociales',
    meta: {
      title: setTitle('Razones Sociales'),
      authRequired: true
    },
    component: () => import('@/views/catalogos/razones_sociales/index.vue')
  }
]
const direccionesRoutes = [
  {
    path: '/direcciones',
    name: 'catalogos.direcciones',
    meta: {
      title: setTitle('Direcciones'),
      authRequired: true
    },
...
const clientesRoutes = [
  {
    ...
    component: () => import('@/views/catalogos/clientes/index.vue')
  }
]
