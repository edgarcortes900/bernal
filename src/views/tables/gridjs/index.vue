<template>
  <VerticalLayout>
      <b-row>
        ...
        <UIComponentCard id="unidades" title="Unidades desde API">
        <GridJsTable id="table-unidades" :options="remoteUnidadesTableOptions" />
      </UIComponentCard>
      </b-row>
  </VerticalLayout>
</template>
...
import { remoteUnidadesTableOptions } from '@/views/tables/gridjs/components/data'
